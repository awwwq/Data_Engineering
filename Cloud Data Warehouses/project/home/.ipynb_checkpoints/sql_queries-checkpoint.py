...
songplay_table_create = ("""
  CREATE TABLE songplays (songplay_id INT IDENTITY(0,1) sortkey, 
...
user_table_create = ("""
  CREATE TABLE users (user_id INT sortkey, 
                      first_name VARCHAR, 
                      last_name VARCHAR, 
                      gender CHAR, 
...
song_table_create = ("""
  CREATE TABLE songs (song_id VARCHAR NOT NULL sortkey distkey, 
...
artist_table_create = ("""
  CREATE TABLE artists (artist_id VARCHAR sortkey, 
...
time_table_create = ("""
  CREATE TABLE time (start_time TIMESTAMP sortkey, 
                     hour INT, 
                     day INT, 
                     week INT, 
                     month INT, 
