...
def process_song_file(cur, filepath):
    """
    Process song file and insert data to song table and artist table. 
    """
    # open song file
...
def process_log_file(cur, filepath):
    """
    Process log file and insert data to time table, user table and songplay table. 
    """
    # open log file
    df = pd.read_json(filepath,lines=True)
...
def process_data(cur, conn, filepath, func):
    """
    Iterately process all file under filepath 
    """
